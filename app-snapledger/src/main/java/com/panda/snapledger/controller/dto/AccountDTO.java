...
public class AccountDTO {
    ...
    private Boolean interestFreeRecommend;
    ...
    public static AccountDTO fromEntity(Account account) {
        ...
        dto.setCreditDueDate(account.getCreditDueDate());
        dto.setCreditLimit(account.getCreditLimit());
        dto.setCreditLimitSharing(account.getCreditLimitSharing());
        dto.setMasterAccountName(account.getMasterAccountName());
        dto.setAutoDebitAccount(account.getAutoDebitAccount());
        dto.setBillDiscount(account.getBillDiscount());
        dto.setInterestFreeRecommend(account.getInterestFreeRecommend());
        dto.setCashbackInfo(account.getCashbackInfo());
